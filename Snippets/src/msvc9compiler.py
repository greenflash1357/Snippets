...
def query_vcvarsall(version, arch="x86"):
    ...
    vcpaths = Reg.read_values(winreg.HKEY_LOCAL_MACHINE, VC_SXS_KEY)
    vcinstalldir = vcpaths[versionstr]
    vsinstalldir = Reg.read_values(winreg.HKEY_LOCAL_MACHINE, VS_SXS_KEY).get(versionstr, vcinstalldir + "..")
